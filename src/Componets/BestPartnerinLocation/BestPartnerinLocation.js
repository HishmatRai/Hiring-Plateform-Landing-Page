...
import Fosil from './../../img/Fosil.png'
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={5}>
          <div className="BestPartnerinLocationCard_main">
            ...
            <div className="PowerCompany_Card_main">
              <img src={Fosil} className="PowerCompanyIcon" />
              <div className="PowerCompany_Card_data">
                <p className="PowerCompany_Card_heading">Fosil.com</p>
                <p className="PowerCompany_Card_des">
                  14 Jobs available work for the positon
                </p>
              </div>
            </div>
            <div className="PowerCompany_Card_main">
              <img src={Fosil} className="PowerCompanyIcon" />
              <div className="PowerCompany_Card_data">
                <p className="PowerCompany_Card_heading">Illuminados.com</p>
                <p className="PowerCompany_Card_des">
                  7 Jobs available work for the positon
                </p>
              </div>
            </div>
          </div>
